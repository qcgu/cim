...
public class GenerateMidi_Segment_01 extends GenerateMidi_Segment {
	private SupervisorMidi supervisor;
	private Randomiser randomiser;
	
	public GenerateMidi_Segment_01(SupervisorMidi supervisor) {
		super(supervisor);
		this.supervisor = supervisor;
		this.randomiser = new Randomiser();
	}

	public GenerateMidi_Segment_01(SupervisorMidi supervisor, MidiSegment segment) {
