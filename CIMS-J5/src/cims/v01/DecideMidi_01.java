...
public class DecideMidi_01 {
	...
	private GenerateMidi_Segment_01 generator_repeatSegment;
	private GenerateMidi_Segment_01 generator_supportSegment;
	private GenerateMidi_Segment_01 generator_initiateSegment;
	private GenerateMidi_Note_01 generator_mirror;
	...
	public DecideMidi_01(SupervisorMidi supervisor) {
		...
		generator_repeatSegment = new GenerateMidi_Segment_01(supervisor);
		generator_supportSegment = new GenerateMidi_Segment_01(supervisor);
		generator_initiateSegment = new GenerateMidi_Segment_01(supervisor);
		generator_mirror = new GenerateMidi_Note_01(supervisor);
	...
	public void messageIn(MidiMessage newMessage) {
		if(mirroring) {
			...
			generator_mirror.transform(GenerateMidi_Note_01.PITCH_SHIFT, 12);
